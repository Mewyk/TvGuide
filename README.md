### Notice
> This repository is still a work in progress with many features and code improvements to come.

# TvGuide
Discord bot written in C# (.NET 10) for automatically displaying and updating information about twitch streams based on added users.
...
> Powerful Discord C# library
- [TwitchSharp](https://github.com/Mewyk/TwitchSharp)
> Modern C# .NET 10 library for the Twitch Helix API and EventSub WebSocket, designed for Native AOT
> NOTE: TwitchSharp is another project of mine.
